...
public class TestGNSSPoint {
	...
	public void testGNSSPointNE() {
		GNSSPoint pt = new GNSSPoint("B0948523340100N01925448EA00261002670080041315512952118-0065-7300100");
	...
	public void testGNSSPointSW() {
		GNSSPoint pt = new GNSSPoint("B1648523340100S01925448WA00261002670080041315512952118-0065-7300100");
